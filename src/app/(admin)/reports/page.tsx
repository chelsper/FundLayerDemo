  ...
  return (
    <div className="grid">
      <section className="hero">
        ...
        <p className="muted">
          Donor recognition totals include eligible hard and soft credits. {brand.name} totals use hard-credit gift
          records only.
        </p>
      </section>
      ...
      <section className="stats">
        <article className="stat">
          <span className="muted">{brand.name} total received to date</span>
          <strong>${(prjTotals.total_received_cents / 100).toLocaleString()}</strong>
        </article>
        <article className="stat">
          <span className="muted">{brand.name} total pledged to date</span>
      ...
      <section className="grid grid-2">
        <article className="table-shell">
          <p className="eyebrow">{brand.name} Total Received By Calendar Year</p>
          <table>
            <thead>
              <tr>
                <th>Year</th>
        ...
        <article className="table-shell">
          <p className="eyebrow">{brand.name} Total Pledged By Calendar Year</p>
          <table>
            <thead>
              <tr>
                <th>Year</th>
