    ...
    <div className="grid dashboard-grid">
      <section className="hero dashboard-hero">
        <div className="dashboard-hero-copy">
          ...
          <h1>{brand.name} Workspace</h1>
          <p className="muted dashboard-subtitle">
            Quickly find donors, add gifts, send receipts, and work inside the demo database.
          </p>
        </div>
      ...
      <section className="stats dashboard-metrics">
        ...
        <article className="stat dashboard-metric-card">
          <span className="muted">Database total received</span>
          <strong>${(totals.prj_total_received_cents / 100).toLocaleString()}</strong>
        </article>
        <article className="stat dashboard-metric-card">
          <span className="muted">Database total pledged</span>
